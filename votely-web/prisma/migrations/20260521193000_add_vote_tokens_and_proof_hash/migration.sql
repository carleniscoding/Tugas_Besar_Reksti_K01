...
ALTER TABLE "votes" ADD COLUMN "proof_hash" VARCHAR(100);
...
CREATE INDEX "vote_tokens_user_id_election_id_used_at_idx" ON "vote_tokens"("user_id", "election_id", "used_at");
